...
interface ThresholdPickerInputInputProps {
  name: string;
  unit: string;
  minValue: number;
  maxValue: number;
...
const ThresholdPickerInputInput: FC<ThresholdPickerInputInputProps> = ({
  name,
  unit,
  minValue,
  maxValue,
  ...
  useEffect(() => {
    if (middleItem !== 0 || middleDecimalItem !== 0) {
  ...
  for (let i = 10; i <= 11; i++) {
    decimalData.push(`${i - 10}`);
  }

  const rightContainerWidth = unit === 'mmol/L' ? '40%' : '20%';
              ...
              <BottomSheet
                ...
                <View style={{alignItems: 'center', width: '100%'}}>
                  ...
                  <View
                    style={{
                      height: 250,
                      width: '50%', // Adjusted width to fit unit text
                      paddingHorizontal: 20,
                      justifyContent: 'center',
                      alignItems: 'center',
                    }}>
                          ...
                          ({item, index: _i}) => (
                            ...
                            <View
                              style={{
                                ...
                                justifyContent: 'center',
                                paddingLeft:
                                  item == middleDecimalItem ? 15 : 35,
                                backgroundColor: Colors.LightGray,
                                marginVertical:
                                  item - middleDecimalItem === 0 ? 1 : 0,
                                borderTopWidth:
                                  item === middleDecimalItem ? 1 : 0,
                                borderBottomWidth:
                                  item === middleDecimalItem ? 1 : 0,
                                borderColor: '#D8D7D9',
                              }}
...
export default ThresholdPickerInputInput;
