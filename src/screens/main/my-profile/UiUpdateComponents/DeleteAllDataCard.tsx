    ...
    <View style={[styles.container, contentContainerStyle]}>
      {isDelete ? (
        <View style={styles.confirmationContainer}>
          <Image
            source={checkCircle}
            style={[styles.confirmationImage, {tintColor: Colors.Green}]}
          />
          <Text style={styles.confirmationTitle}>Deletion complete</Text>
          <Text style={styles.confirmationText}>
            All your health data has been permanently deleted from our servers.
          </Text>
          <View style={styles.footer}>
            <TouchableOpacity
              style={styles.okButton}
              onPress={() => {
                navigation.navigate('NoDataScreen');
                active(false);
              }}>
