                    ...
                    <ScrollView>
                        <View style={{ padding: 20 }}>
                            <View style={styles.boxStyle}>
                                ...
                                <DetailItems name='Do you consume alcohol?' value={data.consumeAlcohol} />
                                <DetailItems name='Use of other substances' value={data.substance} />
                                <DetailItems name='Do you exercise?' value={data.exercise} />
                                <DetailItems name='Stress factor' value={data.stressFactor} />
                                <DetailItems name='Spoken languages' value={data.spokenLanguages} />
                            </View>
                        </View>
                    </ScrollView>
                }
